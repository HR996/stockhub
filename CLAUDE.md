...
DB connection: `postgresql+psycopg://istock:istock@localhost:5432/istock` (host-side), `postgres:5432` (docker-internal).
...
- `k_line_daily` stores 3 price sets (raw/qfq/hfq) in one wide table — factors use `_qfq` (前复权/forward-adjusted).
